...
public class ZTestReport implements IReporter {
	...
	private String templatePath = ResourceUtils.getFile("classpath:report/template").getPath();
	...
	public ZTestReport() throws FileNotFoundException {
		SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMddHHmmssSSS");
		name = formatter.format(System.currentTimeMillis());
	}

	public ZTestReport(String name) throws FileNotFoundException {
		this.name = name;
		if (this.name == null) {
			SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMddHHmmssSSS");
